(function(global) {
	...
	var remoteService = function(beanName, method, sync, scope, relogonFunc, relogonArgs, actionId) {
		return (function() {
			var parameters = [];
			...
			if (!sync) {
				...
				}, scope, relogonFunc, relogonArgs);
				return cb;
			} else {
				var result = miniJsonRequestSync({
					actionId : actionId,
					serviceId : beanName,
					method : method,
					body : parameters
	...
	var remoteServiceCallback = function() {
		var successfun;
		var errorfun;
		var ths = this;
	...
	var miniJsonRequestAsync = function(jsonData, callback, scope, reLogonFunc, relogonArgs) {
	...
	var miniJsonRequestSync = function(jsonData, reLogonFunc, relogonArgs, scope) {
